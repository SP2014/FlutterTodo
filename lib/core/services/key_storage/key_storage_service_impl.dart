import 'package:flutter_todo/core/services/key_storage/key_storage_service.dart';
...
class KeyStorageServiceImpl implements KeyStorageService{
  ...
  bool get isNightMode => _getFromDisk(night_mode_key) ?? false;
  set toggleDarkMode(bool value) => _saveToDisk(night_mode_key, value);
